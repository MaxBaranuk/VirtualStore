...
base.Dispose (disposing);
        ...
        protected CharucoBoard (IntPtr addr) : base(addr)
        {
        }
        ...
        CharucoBoard retVal = new CharucoBoard(aruco_CharucoBoard_create_10(squaresX, squaresY, squareLength, markerLength, dictionary.nativeObj));
        ...
        // C++:  Size getChessboardSize()
        [DllImport(LIBNAME)]
        private static extern void aruco_CharucoBoard_getChessboardSize_10 (IntPtr nativeObj, double[] vals);
