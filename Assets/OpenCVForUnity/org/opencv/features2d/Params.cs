...
base.Dispose (disposing);
        ...
        protected Params (IntPtr addr) : base(addr)
        {
        }
        ...
        public  void set_minRepeatability (IntPtr minRepeatability)
        {
            ThrowIfDisposed ();
#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IOS) && !UNITY_EDITOR) || UNITY_5
        ...
        // C++: void Params::minRepeatability
        [DllImport(LIBNAME)]
        private static extern void features2d_Params_set_1minRepeatability_10 (IntPtr nativeObj, IntPtr minRepeatability);
